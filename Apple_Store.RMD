...
author: "Lakshmi Prasanna Gundabolu"
date: "5/8/2020"
...
```
 ...
 From the plot of Top 10 Genre of Application used by Users we can say that the applications with the genre Games is most popular among the customers. Game genre has the has the highest frequency of usage of 3862 followed by Entertainment, Education and Photo & Video genre.
...
Yes the price of the application depends on the Genre of the application. From the visualization it is clear that applications with the genre Medical have the highest average price of USD 8.78 and applications with genre Utilities have the least price of average USD 1.65.
...
No, the price of the application does not affect the size of the application, it does  not increase as the size of the application increases.The users tend to give more ratings to the application with less size.
...
The Random forest has performed best on the testing data among all the classification models and naive bayes classification algorithm has the least accuracy.
